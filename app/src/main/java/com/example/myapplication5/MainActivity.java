...
public class MainActivity extends AppCompatActivity implements Runnable{
    ...
    public void onClick(View btn) {
        ...
        if (btn.getId() ==R.id.btn_dollar) {
          show.setText(String.format("%.2f",r*dollarRate));
            ...
            show.setText(String.format("%.2f",r*wonRate));//show.setText(String.valueOf(val))都可以.因为是整数，所以不需要强制转换为float类型
        }
    }
    ...
    private void openConfig() {
        ...
        //Intent intentPhone=new Intent(Intent.ACTION_VIEW, Uri.parse("tel:87092173"));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        }else if(item.getItemId()==R.id.oopen_list){
    ...
    public void run() {
        ...
        /*URL url= null;
        try {
            url = new URL("http://www.usd-cny.com/bankogchina.htm");
